...
if (isset($_POST['create'])) {
  ...
  try {
    ...
    $stmt = $conn->prepare("INSERT INTO tbl_staffs_a189646_pt2(fld_staff_id, fld_staff_name,fld_staff_gender,fld_staff_email) VALUES(:sid,:name, :gender,:email)");
...
if (isset($_POST['update'])) {
  ...
  try {
    ...
    $stmt = $conn->prepare("UPDATE tbl_staffs_a189646_pt2 SET
      ...
      fld_staff_gender = :gender,fld_staff_email = :email
