  ...
  <div class="row">
    ...
    <form action="staffs.php" method="post" class="form-horizontal">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-9">
          <input name="phone" type="text" class="form-control" id="staffphone" placeholder="Phone" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_staff_phone']; ?>" required>
        </div>
      </div>
      <div class="form-group">
  ...
  <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
    ...
    <table class="table table-striped table-bordered">
      ...
      try {
        ...
        $stmt = $conn->prepare("SELECT * FROM tbl_staffs_a189646 LIMIT $start_from, $per_page");
        $stmt->execute();
